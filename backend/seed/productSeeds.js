...
const productSeeds = [
  {
    ...
    description: "Apple's upcoming flagship smartphone with cutting-edge technology.",
    price: 1199, // Updated price for the next generation
    category: 'electronics',
    image: 'https://example.com/iphone-16-pro-max-thumb-600x600.jpg', // Placeholder image link
    brand: 'Apple',
    stock: 150, // Increased stock for launch
  },
  {
